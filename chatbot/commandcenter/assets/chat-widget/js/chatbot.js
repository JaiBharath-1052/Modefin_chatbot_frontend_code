					...
					<div class="msg-header">
						<div class="row">
							...
							<div class="col-md-2 col-2 col-2 chatbot-right-click">
							    	<div class="chatbot-refresh" title="Refresh to start new conversation">
...
chatbotClose = iframe.contentWindow.document.getElementsByClassName("close-chat")[0];
...
fpMyScript.src = baseURL+'/assets/chat-widget/@fingerprintjs/fingerprintjs/dist/fp.min.js';
