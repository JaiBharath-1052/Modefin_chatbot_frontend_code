...
declare function getOpenConfidenceScore(components: Pick<BuiltinComponents, 'platform'>): number;
/**
 * Warning for package users:
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getProConfidenceScore(...args: Parameters<typeof getOpenConfidenceScore>): number;
...
export { Agent, BuiltinComponents, Component, Confidence, GetOptions, GetResult, LoadOptions, SourcesToComponents, UnknownComponents, componentsToDebugString, getFullscreenElement, getProConfidenceScore, getScreenFrame, hashComponents, isAndroid, isChromium, isDesktopSafari, isEdgeHTML, isGecko, isTrident, isWebKit, load, loadSources, murmurX64Hash128, prepareForSources, sources };
